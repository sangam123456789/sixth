...
SECRET_KEY = 'django-insecure-_)o2!h4s_1t&kweqb@hn)72chj@aa9!3613+i0&t@)j)d+_i&4'
...
DATABASES = {
    ...
    'default': {
        ...
        'HOST': os.getenv('db.txnbhnzlvgghtjnkpwdr.supabase.co'),
        'NAME': os.getenv('postgres'),
        'USER': os.getenv('postgres'),
        'PASSWORD': os.getenv('Gauravsc@4554'),
        'PORT': os.getenv('5432'),
